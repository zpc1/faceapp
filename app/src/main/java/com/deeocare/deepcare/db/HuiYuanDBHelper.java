...
public class HuiYuanDBHelper extends SQLiteOpenHelper{
        ...
        public HuiYuanDBHelper(Context context, String name, CursorFactory factory, int version)
        {
            super(context, name, factory, version);
        }
        public HuiYuanDBHelper(Context context) {
