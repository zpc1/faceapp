...
public class KeHuDBHelper extends SQLiteOpenHelper{
        ...
        public KeHuDBHelper(Context context, String name, CursorFactory factory, int version)
        {
            super(context, name, factory, version);
        }
        public KeHuDBHelper(Context context) {
