...
import com.deeocare.deepcare.FullyGridLayoutManager;
import com.deeocare.deepcare.R;
import com.deeocare.deepcare.adapter.GridImageAdapter;
...
public class CameraTestActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    private final static String TAG = CameraTestActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new GridImageAdapter(CameraTestActivity.this, onAddPicClickListener);
            ...
            public void onItemClick(int position, View v) {
                if (selectList.size() > 0) {
                    ...
                    switch (mediaType) {
                        case 1:
                            // 预览图片 可自定长按保存路径
                            //PictureSelector.create(CameraTestActivity.this).themeStyle(themeId).externalPicturePreview(position, "/custom_file", selectList);
                            PictureSelector.create(CameraTestActivity.this).themeStyle(themeId).openExternalPreview(position, selectList);
                            break;
                        case 2:
                            // 预览视频
                            PictureSelector.create(CameraTestActivity.this).externalPictureVideo(media.getPath());
                            break;
                        case 3:
                            // 预览音频
                            PictureSelector.create(CameraTestActivity.this).externalPictureAudio(media.getPath());
                            break;
                    }
                }
            }
        ...
        permissions.request(Manifest.permission.WRITE_EXTERNAL_STORAGE).subscribe(new Observer<Boolean>() {
            ...
            public void onNext(Boolean aBoolean) {
                if (aBoolean) {
                    PictureFileUtils.deleteCacheDirFile(CameraTestActivity.this);
                } else {
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            ...
            if (mode) {
                ...
                PictureSelector.create(CameraTestActivity.this)
